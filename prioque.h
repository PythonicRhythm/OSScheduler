// ** VERSION 8.0 **
//
// Priority Queue (c) 1985-2023 by Golden G. Richard III (@nolaforensix)
//
...
// were addressed.
//
// o Queue lengths are now unsigned longs instead of unsigned ints for
// "big data".  :)
//
...
typedef struct Queue {
  ...
  unsigned long magic;                               // set on initialization 
} Queue;
...
// should return 1 if the function successfully reads the element, 0
